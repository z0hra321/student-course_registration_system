...
This project utilizes the Dear ImGui library (MIT License) for GUI development. Special thanks to the open-source community for providing excellent tools and libraries.
